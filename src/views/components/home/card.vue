...
import {Play} from 'lucide-vue-next'//引入lucide-vue图标库
//#endregion 引入import
...
// >div:hover {
//   -webkit-mask: linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.3));
//   mask: linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.3));
// }
.card:hover img{
